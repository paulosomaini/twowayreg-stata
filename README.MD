...
To install the commands without ssc install:
``
Download the commands and put them in PERSONAL or PLUS folder (to search where are this folders run "sysdir" in STATA)	
``
